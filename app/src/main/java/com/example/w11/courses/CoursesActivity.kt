...
class CoursesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        courseList.add(Course(R.drawable.math, "Metody Probavilistyczne i statystyka",3, 6, "Michał Morayne", "Bajkowe przykłady, materiał przerabiany w tempie PKP, egzamin łatwy."))
        ...
        courseList.add(Course(R.drawable.inf_icon, "Architektura komputerów i systempy operacyjne",3, 9, "Marcin Zawada", "Dużo wiedzy, dużo pracy."))
